...
![队列模型23.png](/upload/2021/10/%E9%98%9F%E5%88%97%E6%A8%A1%E5%9E%8B23-55565364ea6449cb9c8dbd090a51890c.png)
...
为了解决**一条消息能被多个消费者消费的问题**，发布/订阅模型就来了。该模型是将消息发往一个Topic即主题中，所有订阅了这个 Topic 的订阅者都能消费这条消息。

![发布订阅模型.png](/upload/2021/10/%E5%8F%91%E5%B8%83%E8%AE%A2%E9%98%85%E6%A8%A1%E5%9E%8B-1de22728135a45e49d5dc7683b402cd8.png)
...
![KafkaTopicPartitioning.png](/upload/2021/10/KafkaTopicPartitioning-11e901506fb34639afb735625bce698a.png)
...
![](https://img-blog.csdnimg.cn/ed41d74588644565983f29ddf741b6d6.png)

- 红色块的partition代表的是主分区，紫色的partition块代表的是备份分区。生产者往topic丢数据，是与主分区交互，消费者消费topic的数据，也是与主分区交互。

- 备份分区仅仅用作于**备份**，**不做读写**。如果某个Broker挂了，那就会选举出其他Broker的partition来作为主分区，这就**实现了高可用**。
...
![](https://img-blog.csdnimg.cn/cc9690db80d5417ba73ef412602c7d78.png)

生产者可以有多个，消费者也可以有多个。像上面图的情况，是一个消费者消费三个分区的数据。多个消费者可以组成一个消费者组。

本来是一个消费者消费三个分区的，现在我们有消费者组，就可以每个消费者去消费一个分区（也是为了提高吞吐量）

![](https://img-blog.csdnimg.cn/413d8982406e4bb497157a0ab3803b3c.png)
...
![zookeeperkafka.jpg](/upload/2021/10/zookeeper-kafka-bb8706a527b5450783b14498e7ae8d0d.jpg)
...
![KafkaTopicPartionsLayout.png](/upload/2021/10/KafkaTopicPartionsLayout-45efc71116424cf78be72ee4c255ff85.png)
...
![kafkaoffset.jpg](/upload/2021/10/kafka-offset-6efab8498e33473fa10f0da2c37581bb.jpg)
